    ...
    var t_methods = {
        init: function (options) {
            ...
            if (settings.swipeOn) {
                ...
                $this.on('touchstart.timelineSwipe', function (e) {
                    $this.timeline('touchStart', e);
                });
                $this.find(settings.itemClass).on('mousedown.timelineSwipe', function (e) {
                    $this.timeline('mouseDown', e.pageX);
                });
                $(document).on('touchend.timelineSwipe', function (e) {
                    data = $this.data('timeline');
                    $this.timeline('touchEnd', data.touchpos);
                });

                $(document).on('mouseup.timelineSwipe', function (e) {
                    var data = $this.data('timeline');
                    if (data.mousedown) {
        ...
        destroy: function () {
            var $this = this,
                data = $this.data('timeline'),
                itemSelector = data && data.options ? data.options.itemClass : '.item';
            $(document).off('mouseup.timelineSwipe');
            $(document).off('mousemove.timelineSwipe');
            $(document).off('touchend.timelineSwipe');
            $(window).off('resize.timeline');
            $this.off('touchstart.timelineSwipe touchmove.timelineSwipe');
            $this.find(itemSelector).off('mousedown.timelineSwipe');
        ...
        touchStart: function (evt) {
            ...
            $this.off('touchmove.timelineSwipe');
            $this.on('touchmove.timelineSwipe', function (e) {
        ...
        mouseDown: function (xpos) {
            ...
            $(document).on('mousemove.timelineSwipe', function (e) {
